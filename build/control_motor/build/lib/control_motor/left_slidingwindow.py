...
class SlideWindow:
    ...
    def __init__(self):
        ...
        self.circle_height = 110
        #self.road_width_ratio= 0.518
        #self.road_width_ratio= 0.465 #original
        self.road_width_ratio = 0.315 #right
        #self.road_width_ratio = 0.285 #left
        self.ema_alpha     = 0.20
    ...
    def slidewindow(self, img):
        ...
        if have_left and have_right:
            ...
            x_center = (xL_now + xR_now) // 2
            self.current_line = "BOTH"
        elif have_left:
            x_center = int(np.polyval(pL, self.circle_height)) + expected_half
            self.current_line = "LEFT"
        elif have_right:
            x_center = int(np.polyval(pR, self.circle_height)) - expected_half
